...
def test_setters(
    ...
    # set our slippages
    strategy.setMaxSlippages(50, 50, {"from": gov})
    with brownie.reverts():
        strategy.setMaxSlippages(50, 50, {"from": whale})
    with brownie.reverts():
        strategy.setMaxSlippages(50, 10001, {"from": gov})
    with brownie.reverts():
        strategy.setMaxSlippages(10001, 50, {"from": gov})
